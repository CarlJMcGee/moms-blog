...
-- CreateTable
CREATE TABLE `UserLikesComments` (
    `userId` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `UserLikesComments` ADD CONSTRAINT `UserLikesComments_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `UserLikesComments` ADD CONSTRAINT `UserLikesComments_commentId_fkey` FOREIGN KEY (`commentId`) REFERENCES `Comment`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
